    ...
    <>
      ...
      <style>{`
        @media (max-width: 768px) {
          .hero-section { height: 80vh !important; min-height: 480px !important; }
          .hero-content { padding: 0 6vw !important; max-width: 100% !important; }
          .hero-scrim { background: linear-gradient(to bottom, rgba(10,22,14,0.35) 0%, rgba(10,22,14,0.75) 75%) !important; }
          .scroll-hint { display: none !important; }
          .stats-grid { grid-template-columns: 1fr !important; gap: 1.5rem !important; }
          .brand-statement { padding: 4rem 6vw !important; }
          .collection-row { grid-template-columns: 1fr !important; min-height: auto !important; }
          .collection-image { height: 280px !important; order: -1 !important; }
          .collection-text { padding: 2.5rem 6vw !important; }
          .services-section { padding: 4rem 6vw !important; }
          .services-header { flex-direction: column !important; align-items: flex-start !important; }
          .services-header p { max-width: 100% !important; }
          .footer-grid { grid-template-columns: 1fr !important; gap: 2.5rem !important; }
        }
        @media (max-width: 480px) {
          .hero-section { height: 75vh !important; min-height: 420px !important; }
          .collection-image { height: 220px !important; }
        }
      `}</style>
    </>
  );
