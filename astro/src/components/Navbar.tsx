...
export default function Navbar() {
  // Plain-browser replacement for Next.js's usePathname().
  // Astro is a multi-page app by default, so we just read the current
  // location on mount rather than relying on client-side route state.
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* LOGO */}
          <a href="/" className="thara-logo" style={{ textDecoration: "none", flexShrink: 0 }}>
