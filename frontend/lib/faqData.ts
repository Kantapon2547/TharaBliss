...
export const FAQ_DATA: FaqEntry[] = [
  ...
  {
    keywords: ["ของขวัญ", "ของชำร่วย", "gift", "แบบฟอร์ม", "สั่งพิเศษ", "custom", "bulk"],
    answer:
      "Thara Bliss ยินดีจัดของขวัญพิเศษและของชำร่วยค่ะ 🎁 สามารถส่งคำขอได้ที่หน้า **Special Gift Request** → https://tharabliss.vercel.app/request\n\nในฟอร์มจะให้กรอก: ชื่อ, อีเมล, ชื่อผู้รับ, โอกาสพิเศษ, สินค้าที่ต้องการ, งบประมาณ และรูปแบบการห่อของขวัญค่ะ ทีมงานจะติดต่อกลับภายใน 1–2 วันทำการนะคะ",
  },
  {
    keywords: ["แพ้ง่าย", "ผิวบอบบาง", "sensitive"],
    answer:
      "ผลิตภัณฑ์เน้นความอ่อนโยน แต่หากมีผิวบอบบางเป็นพิเศษแนะนำให้ทดสอบในปริมาณเล็กน้อยก่อนใช้งานจริงค่ะ หากใช้และพบความผิดปกติใดๆ กรุณาหยุดใช้และปรึกษาแพทย์หรือเภสัชกรทันที",
  },
  {
...
export const QUICK_REPLIES: QuickReply[] = [
  ...
  { label: "🎁 สั่งของขวัญพิเศษ", triggerText: "ของขวัญ สั่งพิเศษ custom gift" },
];