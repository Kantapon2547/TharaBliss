...
const SCENT_GUIDE = [
  {
    ...
    color: "#EAF3EC",
    accent: "#0F6E56",
    description: "กลิ่นหอมอ่อนโยน ช่วยสร้างบรรยากาศแห่งการผ่อนคลาย เหมาะสำหรับช่วงเวลาพักผ่อน",
    best: "ก่อนนอน · โยคะ · การทำสมาธิ",
  },
  {
    ...
    color: "#FBF5DD",
    accent: "#8B6F2E",
    description: "กลิ่นดอกไม้และผลไม้ที่หรูหรา เหมาะสำหรับการใช้งานในชีวิตประจำวัน",
    best: "ทำงาน · นัดสำคัญ · กลางวัน",
  },
  {
    name: "Aqua No.1",
    mood: "Fresh",
    color: "#E6F1FB",
    accent: "#185FA5",
    description: "กลิ่นสะอาด สดชื่น และมีชีวิตชีวา ให้ความรู้สึกโปร่งสบายตลอดวัน",
    best: "เช้าตรู่ · ออกกำลังกาย · กลางแจ้ง",
  },
];
        ...
        <section style={{ maxWidth: 1280, margin: "0 auto", padding: "6rem 6vw" }}>
          ...
          >
            ...
            <p style={{ color: "#888", fontSize: "0.9rem" }}>
              เลือกกลิ่นที่เหมาะกับอารมณ์และกิจกรรมของคุณ
            </p>
          </div>
